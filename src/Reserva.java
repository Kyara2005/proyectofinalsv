...
public class Reserva extends JFrame {
    ...
    private JTextField buscartxt; // Ingreso del ID
    ...
    public Reserva() {
        ...
        buscarButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                String idTexto = buscartxt.getText().trim();
                if (idTexto.isEmpty()) {
                ...
                try {
                    ...
                    if (rs.next()) {
                        ...
                        resumen.setText("<html><b>Nombre:</b> " + nombre +
                        ...
                        resumen.setText("No se encontró ningún huésped con ese ID.");
                    }
                ...
                if (confirm == JOptionPane.YES_OPTION) {
                    try {
                        ...
                        if (res > 0) {
                            ...
                            resumen.setText("Check-out completado para " + nombre);
                            idActual = 0;
                        } else {
